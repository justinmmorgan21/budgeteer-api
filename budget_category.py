...
class BudgetCategory(Base):
  ...
  amount_budgeted: Mapped[float] = mapped_column(Numeric(10, 2))
  amount_accumulated: Mapped[float] = mapped_column(Numeric(10, 2))
  
  category: Mapped[Optional["Category"]] = relationship(back_populates="budget_category")
  budget_tags: Mapped[List["BudgetTag"]] = relationship(
